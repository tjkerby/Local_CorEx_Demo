...
conf = dict(
    classifier = dict(
        ...
        logger = dict(
            # name = 'tb_logs',
            version = f'bs_128_lr_5em4_3_do_0_bn_T_{rep}'
        ),
        trainer = dict(
            devices = 0,
            max_epochs = 200,
    ...
    autoencoder = dict(
        ...
        load_classifier_path = f'./paper_mnist/mnist_classifier/model/base_classifier/rep_{rep}/mnist_clf_epoch=113-val_loss=0.0018.ckpt'
    )
)